...
function Footer() {
  return (
    <div
      ...
      className="d-flex align-items-center justify-content-center flex-column bg-info mt-5"
    >
      <div className="d-flex justify-content-evenly align-items-center w-100">
        ...
        <div className="contacts d-flex flex-column">
          ...
          <div className="d-flex gap-3">
            ...
            <button style={{borderRadius:"5px",color:"black"}} className="btn ms-2 align-items-center justify-content-center d-flex p-3 bg-warning">Subscribe</button>
          </div>
